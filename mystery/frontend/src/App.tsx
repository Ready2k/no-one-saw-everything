...
import { markRewindBriefingSeen } from "./views/RewindIntro";
      ...
      <WorldContext.Provider value={world}>
        <Intro
          onBegin={() => {
            ...
            // The discovery intro is the first-time cinematic.  Its CTA must
            // hand the player straight to a usable investigation surface, not
            // into a second full-screen briefing before they can act.
            markRewindBriefingSeen(world.caseOverview.case_id);
            setShowIntro(false);
            setTab("rewind");
          }}
        />
      ...
      <div className="app">
        ...
        <main className="content">
          ...
          <div className="view-stage" key={tab}>
            {tab === "overview" && <Overview onBegin={() => {
              // The case file already explains the rewind loop.  Starting an
              // investigation should expose the timeline immediately.
              markRewindBriefingSeen(world.caseOverview.case_id);
              setTab("rewind");
            }} />}
            {tab === "rewind" && <Rewind />}
