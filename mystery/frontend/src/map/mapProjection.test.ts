...
function mockData(): MapReplayData {
  return {
    ...
    agents: [
      { agent_id: "agent1", full_name: "Agent 1", age: 30, occupation: "", traits: [], portrait: null, portrait_art: null, sprite_asset: "a", home_location_id: "loc1", work_location_id: "loc2", routine_summary: "", is_victim: false, sprite_id: "a" }
    ],
    events: []
  };
}
