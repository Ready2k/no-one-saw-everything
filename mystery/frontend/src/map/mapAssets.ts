...
// Compatibility marker only: the legacy character sheets may identify moving
// agents on the overhead replay. They are never a style or source reference
// for environments, buildings, evidence, portraits, or cinematic Places art.
// The sheets are a 3x4 grid of frames (columns:
