...
| --- | --- | --- |
| Rear Alley | `rear_alley_fire_hd.avif` | scorched crates, bins, service door, wet cobbles |
| Clara's Flat | `clara_flat_dawn_hd.avif` | desk, coffee table, linen table, kitchen |
| Owen's House & Yard | `owen_yard_dawn_hd.avif` | office door, workshop, timber stacks, truck |
