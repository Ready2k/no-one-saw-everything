...
class CaseFile(BaseModel):
    ...
    # Weather is part of the authored case state. Keeping it constrained lets
    # prose, audio, and the map renderer agree without treating an LLM's free
    # text as a visual instruction.
    weather: Literal["clear", "overcast", "rain", "fog", "wind", "storm", "snow", "slush"] = "clear"
