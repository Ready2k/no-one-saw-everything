...
clip "$ART/rear_alley_fire_hd.png" 5 "$WORK/alley_01.mp4" 1080 1920 "A FIRE HIDES NOTHING" "NOT IN THIS VILLAGE" short
clip "$ART/evidence/melted_lighter.png" 5 "$WORK/alley_02.mp4" 1080 1920 "LOOK CLOSER" "EVERY OBJECT HAS A STORY" short
clip "$ART/map/case_005_village_map_dawn.png" 5 "$WORK/alley_03.mp4" 1080 1920 "FOLLOW THE ROUTE" "THE BACK LANE SAW NO ONE" short
clip "$ART/portraits/owen_price_cracking.png" 5 "$WORK/alley_04.mp4" 1080 1920 "PRESS THE LIE" "WATCH THE STORY CHANGE" short
clip "$ART/overhead/rear_alley_overhead_dawn.png" 7 "$WORK/alley_05.mp4" 1080 1920 "NO ONE SAW EVERYTHING" "PLAY THE CASE" short
...
clip "$ART/portraits/ben_carter_defensive.png" 5 "$WORK/witness_01.mp4" 1080 1920 "EVERYONE REMEMBERS" "SOMETHING DIFFERENT" short
clip "$ART/portraits/nadia_cole_defensive.png" 5 "$WORK/witness_02.mp4" 1080 1920 "ASK AGAIN" "LISTEN FOR THE PAUSE" short
clip "$ART/portraits/elias_grant_cracking.png" 5 "$WORK/witness_03.mp4" 1080 1920 "THEIR FACES CHANGE" "WHEN THE EVIDENCE FITS" short
clip "$ART/evidence/mortgage_deed.png" 5 "$WORK/witness_04.mp4" 1080 1920 "BUILD THE CASE" "ONE CLUE AT A TIME" short
clip "$ART/village_square_dawn_hd.png" 7 "$WORK/witness_05.mp4" 1080 1920 "NO ONE SAW EVERYTHING" "A FAIR-PLAY MYSTERY" short
...
clip "$ART/map/case_005_village_map_dawn.png" 7 "$WORK/trailer_01.mp4" 1920 1080 "ONE VILLAGE" "ONE UNSEEN ROUTE" trailer
clip "$ART/rear_alley_fire_hd.png" 7 "$WORK/trailer_02.mp4" 1920 1080 "ONE MORNING TO REWIND" "THE REAR ALLEY FIRE WAS NO ACCIDENT" trailer
clip "$ART/evidence/builders_belt.png" 6 "$WORK/trailer_03.mp4" 1920 1080 "EVERY CLUE CONNECTS" "IF YOU KNOW WHERE TO LOOK" trailer
clip "$ART/portraits/owen_price_cracking.png" 7 "$WORK/trailer_04.mp4" 1920 1080 "NO ONE SAW EVERYTHING" "PLAY THE CASE" trailer
