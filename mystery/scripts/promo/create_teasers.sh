...
make_clip "$ART/village_square_dawn_hd.png" 5.5 "$WORK/cinematic_01.mp4" 1920 1080 "A village keeps its secrets" "ONE MORNING. ONE MURDER." cinema
make_clip "$ART/cafe_storage_room_hd.png" 5.5 "$WORK/cinematic_02.mp4" 1920 1080 "Marcus Bell is dead" "THE CLOCK STOPPED AT 08.12" cinema
make_clip "$ART/rear_alley_hd.png" 5.5 "$WORK/cinematic_03.mp4" 1920 1080 "Every witness has a story" "NOT EVERY STORY IS TRUE" cinema
make_clip "$ART/marcus_study_hd.png" 5.5 "$WORK/cinematic_04.mp4" 1920 1080 "Find the contradiction" "BEFORE THE TRAIL GOES COLD" cinema
